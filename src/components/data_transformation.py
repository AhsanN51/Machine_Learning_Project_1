...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join("model_data", "preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        try:
            logging.info("-> Loading processor pipelines")
            ...
            logging.info(f"num_pipleline intialized")
            ...
            logging.info(f"cat_pipleline intialized")
    ...
    def initiate_data_transformation(self, train_file_path, test_file_path):
        try:
            logging.info("Entered Transformer    !!!")
            train_data = pd.read_csv(train_file_path)
            test_data = pd.read_csv(test_file_path)

            logging.info(f"Train Data and Test Data loaded")
            ...
            logging.info("Data transformation on train and test data completed !!!")
